...
class LogsPage extends StatelessWidget {
          ...
          children: [
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text('Manual meter readings history & calibration logs',
            ...
            Row(
              children: [
                ...
                const Spacer(),
                Text('${logs.length > 10 ? 10 : logs.length} of ${logs.length}',
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 3),
                      Text(
                          'Manual readings logged from Settings will appear here.',
                ...
                child: Column(
                  children: [
                    for (var i = 0; i < logs.length && i < 10; i++) ...[
                      ...
                      _LogRow(
                          log: logs[i],
                          meter: p.meter(logs[i].meterId),
                          onDelete: () => p.deleteLog(logs[i].id)),
                    ],
                  ],
                ),
              ),
  ...
  String? _delta(MeterState m) {
    ...
    final last = m.lastLoggedReading;
    if (last == null) return null;
    final d = m.reading - last;
...
class _LogRow extends StatelessWidget {
  ...
  const _LogRow(
      {required this.log, required this.meter, required this.onDelete});
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(log.reading.toStringAsFixed(1),
